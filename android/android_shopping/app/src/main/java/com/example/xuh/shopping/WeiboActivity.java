...
import com.example.administrator.uploadphoto.UploadPicActivity;
...
import wwy.com.listview_add_gridandlistview.ListFragment;
...
public class WeiboActivity extends AppCompatActivity {
    ...
    private String[] tabText = {"首页", "商城", "消息", "我的小窝"};
    ...
    protected void onStart() {
        super.onStart();
        phone = this.findViewById(R.id.myphone);
    }*/
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        changeFragments.add(new Index_home());
        ...
        for (int i = 0; i < 4; i++) {
            ...
            if(i == 0){
                menuImage.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        Intent intent = new Intent(WeiboActivity.this,FaBu.class);
                        Bundle bundle = new Bundle();
                        bundle.putString("user_id",temp);
